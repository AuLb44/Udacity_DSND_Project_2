...
from utils import load_model, plot_ml_performance

# Dashboard title
DASHBOARD_TITLE = "Employee Performance"
...
class Header(BaseComponent):
    ...
    def build_component(self, entity_id, model):
        ...
        return H1(f"{DASHBOARD_TITLE} - {model.name.title()}")  # noqa: F405
...
def generate_ml_visualization():
    """Generate ML performance visualization and save to assets folder."""
    assets_dir = Path(__file__).resolve().parent.parent / 'assets'
    assets_dir.mkdir(exist_ok=True)
    outpath = assets_dir / 'ml_performance.png'

    # Create sample department counts for visualization
    dept_counts = {
        'Engineering': 45,
        'Sales': 32,
        'Marketing': 28,
    ...
    plot_ml_performance(dept_counts, outpath)
    return outpath
...
# Generate ML visualization at startup
generate_ml_visualization()
